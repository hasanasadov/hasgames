...
const ConnectFour = () => {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-gray-100  bg-star text-white">
        ...
        {board.map((row, rowIndex) =>
          row.map((cell, colIndex) => (
            <div
              ...
              className="w-16 h-16 bg-gray-300 border-2 border-gray-600 flex items-center justify-center cursor-pointer rounded-full"
